...
(function(factory) {
     ...
     ********************/
        ...
        _resetToDialCode: function(dialCode) {
          ...
          if(!$(".areacode") || $(".areacode").text() == ''){
            $('.arrow').before("<span class='areacode'>"+value+"</span>");
          }else{
            $(".areacode").text(value);
          }
        ...
        _updateNumber: function(newDialCode) {
            ...
            $('.selected-flag .flag span').text(newNumber);
 ...
 */
    ...
    // https://libphonenumber.googlecode.com/svn/trunk/javascript/i18n/phonenumbers/metadata.js
